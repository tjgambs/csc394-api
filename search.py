...
def automated(student):
    ...
    # number_of_classes_per_quarter is the max number of courses a student is willing to take in a given quarter.
    ...
    while not frontier.empty():
        ...
        for suggestedCourse in options:                             # TODO: getOptions will be the database query

            new_cost = costSoFar[current] + 32                      # TODO: 32 is the arbitrary constant cost of selecting a class described above
            suggestedPlan = Plan(current.selectionOrder, current.coursesTaken, current.termNum, number_of_classes_per_quarter)
...
# TODO: Will need to account for selecting multiple courses in a single term, or selecting zero courses in a single term before advancing.
